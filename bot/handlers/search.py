...
def show_search_prompt(bot: TeleBot, chat_id: int, message_id: int, telegram_id: int) -> None:
    ...
    text = build_screen(
        ...
        title="جستجوی غذا",
        description=[
            "نام غذا یا یکی از مواد آن را بنویس.",
            "جستجو در نام، توضیحات و مواد اولیه انجام می‌شود.",
        ],
        details=[
            "💡  حداقل ۲ حرف",
            "📝  مثال: قورمه سبزی، مرغ، بادمجان، پلو",
        ],
        footer="👇 عبارت جستجو را در پیام بعدی بفرست",
    )
